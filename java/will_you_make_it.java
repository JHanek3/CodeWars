...
Considering these factors, write a function that tells you if it is possible to get to the pump or not. Function should return true (1 in Prolog) 
...
/* We dont get an error in vsc when this class exists, use this format so the code isn't all commented out for github submissions*/
